...
class Follow(models.Model):
    follower = models.ForeignKey(User, on_delete=models.CASCADE, related_name='Followers', verbose_name='Followers')
    following = models.ForeignKey(User, on_delete=models.CASCADE, related_name='Following', verbose_name='Suivi(e)s')
